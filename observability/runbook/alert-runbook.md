...
1. [High Latency](#high-latency)
2. [High Error Rate](#high-error-rate)
3. [Pod CrashLoopBackOff](#pod-crashloopbackoff)
4. [Pod Not Ready](#pod-not-ready)
5. [High Memory Usage](#high-memory-usage)
6. [High CPU Usage](#high-cpu-usage)
7. [OpenTelemetry Collector Down](#opentelemetry-collector-down)
8. [OpenTelemetry Collector High Error Rate](#opentelemetry-collector-high-error-rate)
...
_Add screenshots of alert responses here:_

### High Latency Alert Response
![High Latency Alert](screenshots/high-latency-alert.png)
_Description: Screenshot showing HighLatency alert in Alertmanager UI_

### Error Rate Dashboard
![Error Rate Dashboard](screenshots/error-rate-dashboard.png)
_Description: Screenshot of Grafana error rate dashboard showing spike_

### Pod CrashLoop Investigation
![Pod CrashLoop](screenshots/pod-crashloop.png)
_Description: Screenshot of kubectl describe pod output showing CrashLoopBackOff_
